          ...
          <div className="hidden sm:flex gap-1 items-center">
            {["About", "Products", "For Teams"].map((item) => (
              <Link
                key={item}
                href="/"
                className="text-sm text-[#454545] font-medium px-3 py-2 rounded hover:bg-gray-200 transition"
              >
                {item}
              </Link>
            ))}
            <Link
              href="/pricing"
              className="text-sm text-orange-700 font-semibold px-3 py-1.5 rounded bg-orange-50 hover:bg-orange-100 border border-orange-200 flex items-center gap-1.5 transition"
            >
